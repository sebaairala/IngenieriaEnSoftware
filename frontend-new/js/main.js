...
$(document).ready(function () {
  ...
  {
    name = $('#name-input-create').val();
    user = $('#user-input-create').val();
    password = $('#password-input-create').val();
    email = $('#email-input-create').val();
    URL = URLBASE+"/user";
    myData = 'name=' + name + '&user=' + user + '&password=' + password + '&email=' + email;
    jQuery.ajax({
      type: "POST",
      url: URL,
      data: myData,
